...
BENCHMARK_CAPTURE(BM_read, taobao, jsonDir.c_str())
    ->Unit(benchmark::kMillisecond);
BENCHMARK_CAPTURE(BM_read_parse, taobao, jsonDir.c_str())
    ->Unit(benchmark::kMillisecond);
BENCHMARK_CAPTURE(BM_read_parse_write, taobao, jsonDir.c_str())
    ->Unit(benchmark::kMillisecond);
